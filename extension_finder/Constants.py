...
class WinBrowsers(Enum):
    ...
    FIREFOX_NAME = 'Firefox - Windows'
    FIREFOX_EXTENSIONS = r'AppData\Roaming\Mozilla\Firefox\Profiles\ijfnxm93.default-release\extensions'
    FIREFOX_EXTENSIONS_PREFS = r'AppData\Local\Mozilla\Firefox\Profiles'
